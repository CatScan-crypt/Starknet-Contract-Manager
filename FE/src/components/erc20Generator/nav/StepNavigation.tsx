...
const StepNavigation: React.FC<StepNavigationProps> = ({ currentStep, onNavClick, canGoPrevious, canGoNext, handlePreviousClick, handleNextClick }) => {
  return (
    <nav className="md:w-64 mb-8 md:mb-0 flex-shrink-0">
      {/* THIS IS THE KEY CHANGE: Include the buttons inside the sticky div */}
      <div className="sticky top-8">
        <h3 className="text-lg font-semibold text-gray-800 mb-4 px-20">Navigation</h3>
        ...
        {/* The Previous/Next buttons are now inside the sticky container */}
        <div className="flex justify-center gap-8 mt-8">
          <button
            ...
            `}
            onClick={canGoPrevious ? handlePreviousClick : undefined}
